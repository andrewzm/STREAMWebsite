...
Meet the researchers of STREAM.
...
::: {.column width="75%"}
**Yan Gong** · *Visiting Assistant Professor (MBZUAI)*
...
Daniel Fynn is a PhD candidate at the University of Wollongong, supervised by David Gunawan and Andrew Zammit-Mangion. His research focuses on inference for high-dimensional time-series dependence models, with particular emphasis on copula-based methods. He is currently working on fast amortised inference for time-series copula models using neural networks. In parallel, he is developing a real-time prediction framework for wave conditions under the TIDE project, based on stationary Markov vine copula models.
...
::: {.column width="25%"}
![](images/Marcus.jpeg){.person-photo}
:::

::: {.column width="75%"}
**Marcus Dyson** · *PhD Student (UWA)*

Marcus Dyson is a PhD candidate at the University of Western Australia under the supervision of Lachlan Astfalck, Thomas Stemler, and Edward Cripps. He is affiliated with the ARC Industrial Transformation Research Hub for Transforming Energy Infrastructure through Digital Engineering (TIDE). His research focuses on constructing error minimising estimators of the power spectral density, including for irregularly observed data. Alongside this work, he is developing a software suite in Python for modern spectral analysis.

[<i class="bi bi-envelope" aria-label="Email"></i>](mailto:marcus.dyson@uwa.edu.au) · [Google Scholar](https://scholar.google.com/citations?user=8JqFimsAAAAJ&hl=en&oi=ao) · [LinkedIn](https://www.linkedin.com/in/marcus-dyson/)
:::
...
::: {.column width="25%"}
![](images/Max.png){.person-photo}
:::

::: {.column width="75%"}
**Max Coten** · *PhD Student (UWA)*

Max Coten is a Westpac Future Leader scholar and PhD student at the University of Western Australia under the supervision of Lachlan Astfalck and Nicole Jones. He works at the interface of spatio-temporal statistical methods for oceanographic applications, with a focus on statistical machine learning. He is also an avid open water swimmer having won the Rottnest Channel Swim and competed internationally in the 10km open water swim.

[<i class="bi bi-envelope" aria-label="Email"></i>](mailto:23354577@student.uwa.edu.au) · [LinkedIn](https://au.linkedin.com/in/maxcoten)
:::
